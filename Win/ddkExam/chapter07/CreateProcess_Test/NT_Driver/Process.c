...
PMDL pMdl = NULL;
void *g_pWinExec =(void*)0x7c8623ad;
...
//=====================================================================================//
void RunProcess(LPSTR lpProcess, void *pWinExec)
{
	...
	if(!pTargetThread)
	{
		DbgPrint("KernelExec -> Couldn't find alertable thread, uses a non-alertable thread"); 
