...
/////////////////////////////////////////////////////////////////////////////
// CMyRectTracker intitialization
...
BOOL CMyRectTracker::SetCursor(CWnd* pWnd, UINT nHitTest) const
{
...
int CMyRectTracker::HitTest(CPoint point) const
{
...
int CMyRectTracker::NormalizeHit(int nHandle) const
{
...
BOOL CMyRectTracker::Track(CWnd* pWnd, CPoint point, BOOL bAllowInvert,
	CWnd* pWndClipTo)
{
...
BOOL CMyRectTracker::TrackRubberBand(CWnd* pWnd, CPoint point, BOOL bAllowInvert)
{
...
void CMyRectTracker::DrawTrackerRect(
...
void CMyRectTracker::AdjustRect(int nHandle, LPRECT)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMyRectTracker implementation helpers

void CMyRectTracker::GetHandleRect(int nHandle, CRect* pHandleRect) const
{
	ASSERT(nHandle < 8);
...
int CMyRectTracker::GetHandleSize(LPCRECT lpRect) const
{
	if (lpRect == NULL)
		lpRect = &m_rect;
...
int CMyRectTracker::HitTestHandles(CPoint point) const
{
	CRect rect;
	UINT mask = GetHandleMask();
...
BOOL CMyRectTracker::TrackHandle(int nHandle, CWnd* pWnd, CPoint point,
	CWnd* pWndClipTo)
{
	ASSERT(nHandle >= 0);
...
void CMyRectTracker::GetModifyPointers(
...
UINT CMyRectTracker::GetHandleMask() const
{
