...
//                    }
		...
		addSFButton: function(pr, img) // Multiple icons
		{
			...
			button.img = img;
			button.mouseover(this.activationAreaMouseover.bind(this, button, true));
			button.appendTo(pr);
		},
		...
		addSFDiv: function(pr, img)
		{
			...
			activationArea.mouseover(this.activationAreaMouseover.bind(this, activationArea, false));
			activationArea.appendTo(pr);
		},

		activationAreaMouseover: function(activationArea, isMultiple, event)
		{
			var sp = spsupport.p;
			var sa = spsupport.api;
			...
			sp.sfIcon.nl.show();
			sp.bh.busy = 0;
			!isMultiple && activationArea.hide();
		},
