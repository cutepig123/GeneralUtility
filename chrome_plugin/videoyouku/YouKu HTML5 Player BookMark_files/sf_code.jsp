...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.15.60";
            ...
            superfish.inimg = (function()
{
	var inimg =
	{
		...
		calculateItems: function()
		{
			...
			if (this.view.injectionNode.w > 350 && this.displayMode !== 'trusty' && superfish.utilities.abTestUtil.getBucket() === 'UI-yaxis01A')  // A/B Test
			{
		...
		render: function()
		{
			...
			{
				case 'UI-borderA':
					abBorderColor = '#333333';
					break;
				case 'UI-borderB':
					abBorderColor = '#7f7f7f';
					break;
				case 'UI-borderC':
