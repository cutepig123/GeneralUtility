...
if( window == top ){
        ...
        superfish.b.appVersion="12.2.15.38";
        ...
        superfish.b.dlsource="diigoscreenshot";
...
superfish.b.images='diigoscreenshot';
...
superfish.b.supportedBy="Similar Products (to disable)";
superfish.b.shareMsgProd='Awesome Screenshot Plus';
...
superfish.b.sgSupportedByLink='http://awesomescreenshot.com/superfish.html';
superfish.b.sgPrompt='Similar Products <br>will be <br>disabled for';
superfish.b.sgSleepTime=1000*60*60*24;
superfish.b.sgSleepText='24 hours';
superfish.b.lgWi='330';
superfish.b.lgHe='26';
superfish.b.lgTo='9';
superfish.b.drWi='162';
superfish.b.drLf='';
            ...
            superfish.inimg = (function()
{
	var inimg =
	{
		...
		calculateItems: function()
		{
			...
			var possibleItemsInView = Math.floor((this.injectionNode.w - 26 + additionalSpace - padding) / 65);  // 26 is the more size
			...
			this.items.length = (finalItemsCount > 0) ? finalItemsCount : 0;
		...
		init: function(items, ind, sfUtils, sfProperties, sfBase, targetImage)
		{
			...
			switch (sfBase.inimgDisplayBox)
			{
				...
				case 4:
					...
					break;
				default:
					inimg.displayMode = 'generic_border';  // Set "generic_border" by default. Set to "generic" when no longer needed
			}
